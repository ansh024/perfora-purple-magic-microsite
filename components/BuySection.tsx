      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className={`transition-all duration-700 delay-200 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className="hidden md:grid md:grid-cols-2 gap-12 items-center px-6">
            ...
            {/* Product image — 20% larger via w-full filling column */}
            <div className="relative flex justify-center">
              <div className="relative w-full">
                ...
                <div className="absolute -top-3 -right-3 bg-[#7c3aed] text-white text-sm font-bold px-4 py-1.5 rounded-full shadow-lg">
                  {activePack.discount}
                </div>
              </div>
            </div>
