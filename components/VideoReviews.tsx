...
const videos = [
  {
    ...
    price: "₹887",
    label: "Pack of 2",
    img: "/ai-created/model-holding.png",
    gradient: null,
  },
  {
    id: 2,
    ...
    label: "Pack of 3",
    img: null,
    gradient: "from-[#3b0764] via-[#6d28d9] to-[#a855f7]",
  },
  {
    id: 3,
    reviewer: "Meera J.",
    ...
    price: "₹887",
    label: "Pack of 2",
    img: "/ai-created/model-giant-tube.png",
    gradient: null,
  },
  {
    id: 4,
    ...
    label: "Pack of 3",
    img: null,
    gradient: "from-[#1e1b4b] via-[#4338ca] to-[#7c3aed]",
  },
  {
    id: 5,
    reviewer: "Vikram T.",
  ...
  },
  {
    ...
    label: "Pack of 3",
    img: null,
    gradient: "from-[#2e1065] via-[#5b21b6] to-[#8b5cf6]",
  },
];
  ...
  return (
    <section ref={sectionRef} className="bg-[#0a0614] py-10 md:py-16 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Header */}
        <div className={`px-5 md:px-6 mb-6 md:mb-10 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className="flex items-end justify-between">
            ...
            <span className="text-white/40 text-xs md:text-sm hidden md:block" style={{ fontFamily: "var(--font-inter)" }}>
              6,093+ verified buyers
            </span>
          </div>
        </div>

        {/* Carousel — horizontal scroll on both mobile and desktop */}
          ...
          <div className="flex gap-3 md:gap-4 overflow-x-auto pb-4 px-5 md:px-6 scrollbar-hide snap-x snap-mandatory">
            {videos.map((v) => (
              <div key={v.id} className="flex-shrink-0 w-[160px] md:w-[200px] snap-start">
                ...
                <div className="text-white/60 text-[10px] mt-1" style={{ fontFamily: "var(--font-inter)" }}>
                  Verified review · {v.location}
                </div>
              </div>
            ))}
          </div>
