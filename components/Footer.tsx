      ...
      <div className="max-w-6xl mx-auto px-6 pt-12 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="md:col-span-1">
            ...
            />
            <p className="text-white/40 text-xs leading-relaxed mb-6" style={{ fontFamily: "var(--font-inter)" }}>
            ...
            {/* Happy to Help */}
            <h4 className="text-white/60 text-[10px] font-semibold tracking-[0.15em] uppercase mb-3" style={{ fontFamily: "var(--font-inter)" }}>
              Happy to Help
            </h4>
            <ul className="flex flex-col gap-2.5">
              <li>
                <a href="https://api.whatsapp.com/send?phone=919999289288&text=Hi" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/40 hover:text-white text-xs transition-colors" style={{ fontFamily: "var(--font-inter)" }}>
              ...
              <li>
                <a href="mailto:hello@perforacare.com" className="flex items-center gap-2 text-white/40 hover:text-white text-xs transition-colors" style={{ fontFamily: "var(--font-inter)" }}>
                  <svg className="w-3.5 h-3.5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg>
                  hello@perforacare.com
                </a>
              </li>
              <li className="flex items-center gap-2 text-white/30 text-xs" style={{ fontFamily: "var(--font-inter)" }}>
              ...
              <li>
                <a href="https://maps.app.goo.gl/QMby8JCFe483D2bT6" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/40 hover:text-white text-xs transition-colors" style={{ fontFamily: "var(--font-inter)" }}>
          ...
          <div className="md:col-span-1">
            <h4 className="text-white/60 text-[10px] font-semibold tracking-[0.15em] uppercase mb-4" style={{ fontFamily: "var(--font-inter)" }}>
              Quick Links
            </h4>
            <ul className="flex flex-col gap-2.5">
              {quickLinks.slice(0, 7).map((item) => (
                <li key={item.label}>
                  <a href={item.href} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white text-xs transition-colors" style={{ fontFamily: "var(--font-inter)" }}>
                    {item.label}
                  </a>
                </li>
              ))}
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-white/40 text-xs leading-relaxed mb-4" style={{ fontFamily: "var(--font-inter)" }}>
        ...
        <div className="flex gap-3">
          {socials.map((s) => (
            <a
              ...
              aria-label={s.label}
              className="w-8 h-8 rounded-full bg-white/5 hover:bg-[#7c3aed]/30 text-white/40 hover:text-white flex items-center justify-center transition-all duration-200"
            >
              {s.icon}
            </a>
          ))}
